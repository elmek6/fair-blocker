...
export const PRIORITY_SITE_EXEMPT = 3_500; // yerleşik site muafiyeti (örn. YouTube — player'da işlenir)
...
export const ID_YT_EXEMPT = 9_000_001; // tekil "YouTube muaf" allowAllRequests kural id'si
